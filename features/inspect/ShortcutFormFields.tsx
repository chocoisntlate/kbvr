...
export function Input({ value, onChange, error, disabled }: InputProps) {
  return (
    <input
      className={`rounded-md border px-2 py-1 text-xs dark:bg-neutral-800 dark:text-neutral-100 focus:outline-none focus:border-teal-500 dark:focus:border-teal-400 ${
