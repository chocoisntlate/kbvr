    ...
    <ModalShell>
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          className="mb-2 w-full rounded-md border border-neutral-300 px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-neutral-400 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
        />
        {error && (
